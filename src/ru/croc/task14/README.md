Вы реализовали фильтрацию комментариев по “черному списку” слов ([задача 12](https://github.com/Xentention/Croc-Java-school/tree/master/src/ru/croc/task12)) и с чистой совестью ушли в отпуск на 3 недели.
